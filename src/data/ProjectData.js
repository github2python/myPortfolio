...
export const ProjectList = [
  {
    ...
    title: "Mini-Insta",
    description:
      "A social media application to share photos and with feature of linkes and dislikes",
    tech_stack: ["Tailwind CSS", "Firebase"],
    github_url: "https://github.com/github2python/blockchain-project",
    demo_url: "",
  },
  {
    ...
    title: "Travizz",
    description:
      "An app where users can plan their journeys and maintain itinerary while seeing realtime map and the important locations near to their destination.",
    tech_stack: ["HTML", "CSS", "NodeJs", "MongoDB", "SocketIo","ReactJs"],
    github_url: "https://github.com/github2python/hackfest_2k23",
    demo_url: "",
  },
  // {
